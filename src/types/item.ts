...
export const defaultItems: Item[] = [
  {
    id: "1",
    name: "Vintage Camera",
    // Use the base64 fallback image instead of external placeholder
...
// Default fallback image in case imageUrl is not available
...
// Rest of your item.ts file stays the same